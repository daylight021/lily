...
async function convertVideoToWebP(inputPath, outputPath, metadata, quality = 85, compression = 3) {
  return new Promise((resolve, reject) => {
    ...
    const ffmpegProcess = ffmpeg(inputPath)
      ...
      .outputOptions([
        "-vcodec", "libwebp",
        `-vf`, `scale='min(512,iw)':-2:force_original_aspect_ratio=decrease,fps=24`,
        "-lossless", "0",
...
async function smartCompress(inputPath, outputPath, targetSize = 800 * 1024, isAnimated = false) {
  ...
  const strategies = isAnimated ? [
    ...
    { quality: 80, resolution: 512, fps: 24, method: 4 },
    { quality: 70, resolution: 512, fps: 20, method: 5 },
    { quality: 60, resolution: 450, fps: 15, method: 6 },
    { quality: 50, resolution: 400, fps: 12, method: 6 },
    { quality: 40, resolution: 350, fps: 10, method: 6 },
    { quality: 35, resolution: 300, fps: 8, method: 6 },
    { quality: 30, resolution: 280, fps: 8, method: 6 },
